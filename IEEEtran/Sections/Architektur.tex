...
\begin{enumerate}
	...
	\item \textbf{Konsumenten:} konsumiert Cloudlösungen
...
Zugriff zum Netzwerk erlangen. \cite{Badger}
...
Dies verringert Flexibilität des Konsumenten. \cite{Badger}
...
Eine Erhöhung der verfügbaren Ressourcen kann jedoch vom Provider nur manuell geschehen, sofern dieser über genug Ressourcen verfügt. \cite{Badger}
...
die Ressourcen lokal bereitgestellt werden und somit limitiert sind. Wodurch die Flexibilität der einzelnen Organisationen sinkt. \cite{Badger}
...
Das selbe gilt bei der Wahl des Betriebssystems und der Hardware, bei der der Konsument keinen Einfluss hat. \cite{Badger}
...
\begin{figure}[H]
    \centering
	\includegraphics[width=0.45\textwidth]{Images/SaaSM1}
...
\subsection{Cloud Applikation Architektur}