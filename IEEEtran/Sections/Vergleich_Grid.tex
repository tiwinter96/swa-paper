...
Während Cloud Computing hauptsächlich Lösungen für verschiedene webbasierte Businessfälle bietet, also eher einem kommerziellen Zweck dient, wird Grid Computing dagegen mehr in wissenschaftlichen Projekten bei rechenintensiven Aufgaben eingesetzt.
...
% In der Abbildung \ref{gpa} sind fünf Schichten der Grid Protokollarchitektur dargestellt. Jede einzelne Schicht hat einen spezifischen Zweck und stellt entsprechende Protokolle bereit.
...
Grid Computing baut nicht so viel auf der Virtualisierung wie Cloud Computing, was allerdings daran liegen kann, dass jede einzelne Organisation ihre eigenen Ressourcen, die nicht notwendigerweise virtualisiert sind, verwalten will\cite{360-degree-compared}. 
...
Compute Model (Batch-scheduled compute model bei Grid vs Cloud etc.) usw.
